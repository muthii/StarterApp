...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          <div class="image">
          <img src="{{ asset ('dist/img/new_avatar.png') }}" class="img-circle elevation-1" width="30" height="30" alt="User Image">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{ asset ('dist/img/Strathmore-University-300x217.jpg') }}" alt="SU Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
